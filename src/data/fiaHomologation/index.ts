 ...
 * LIST_CONFIG for ones still pending (40, 91 — messier layouts, not yet trusted).
 *
 ...
 */
export const FIA_TECHNICAL_LISTS: FiaTechnicalList[] = [list74, list57, list24, list16, list12, list27, list29] as FiaTechnicalList[];
