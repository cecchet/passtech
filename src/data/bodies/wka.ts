    ...
    helmet: {
      ...
      acceptedStandards: [
        ...
        { standardId: "snell-m2025r", expiresOn: "2035-12-31" },
        {
          ...
          note: "Youth kart-specific rating — no explicit expiration rule stated in this document; using the same 10-years-from-manufacture convention every other karting body in this app cites for it. Snell certification tags don't print a manufacture/expiration date (unlike SFI/FIA), so this is computed as 10 years from the CMR2016 standard's own release year, matching the fixed calendar dates used for the other Snell generations above.",
        },
