  ...
  categories: {
    helmet: {
      ...
      acceptedStandards: [
        ...
        {
          standardId: "sfi-31.1-2020",
          expiresOn: "2030-12-31",
          note: "Document cites 'SFI 31.1' generically without a year/slash-level. SFI 31.1 tags don't print a manufacture date the way FIA labels do, so this is computed as 10 years from the 2020 spec generation instead.",
        },
        { standardId: "sfi-31.1-2015", expiresOn: "2025-12-31", note: "Same 10-years-from-generation-year computation as sfi-31.1-2020 above." },
        {
          standardId: "bs-6658-1985",
          noExpiration: true,
          note: "BS 6658-85 is a single, never-revised standard (unlike Snell/SFI 31.1, which cycle through dated generations) — its own '1985' is the standard's original publication year, not a rolling generation marker, so there's no valid year to compute a fixed cutoff from. The tag itself prints no manufacture date either (see sample BS 6658-85 label), so this document's 10-year age cap can't be checked against it here.",
        },
    ...
    helmet: {
      ...
      acceptedStandards: [
        ...
        { standardId: "snell-sah2010", expiresOn: "2020-12-31", note: "Same 10-years-from-generation-year computation as SA2025 above — already outside its 10-year window by today's date." },
        {
          standardId: "sfi-31.1-2020",
          expiresOn: "2030-12-31",
          note: "Rulebook cites bare 'SFI 31.1' without a slash-level or generation year — mapped to the two most recent registered SFI 31.1 generations as a reasonable representative match, not verified name-for-name. SFI 31.1 tags don't print a manufacture date the way FIA labels do, so this is computed as 10 years from the 2020 spec generation instead.",
        },
        { standardId: "sfi-31.1-2015", expiresOn: "2025-12-31", note: "Same 10-years-from-generation-year computation as sfi-31.1-2020 above." },
        {
          standardId: "bs-6658-1985",
          noExpiration: true,
          note: "Rulebook: 'BS6658-85 type A/FR.' BS 6658-85 is a single, never-revised standard (unlike Snell/SFI 31.1, which cycle through dated generations) — its own '1985' is the standard's original publication year, not a rolling generation marker, so there's no valid year to compute a fixed cutoff from. The tag itself prints no manufacture date either, so the rulebook's 10-year age cap can't be checked against it here.",
        },
